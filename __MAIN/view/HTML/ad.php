...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1>ANIMAL WELFARE SYSTEM AT YOUR FINGERTIPS</h1>
            <p>Connecting shelters, resources, and animal lovers. Report lost pets, find adoptions, access vital services.</p>
        </div>
    </section>
    ...
    <section class="hero-bottom">
        <div class="hero-content">
            <h1>Help Animals in Need Today!</h1>
            <p>Join our community to report lost pets, find resources, and adopt furry friends.</p>
        </div>
    </section>
    ...
    <section class="how-it-works">
        ...
        <div class="steps">
            <div class="step">
                ...
                <h3>Report</h3>
                <p>Report lost or found pets to connect with their owners or find new homes.</p>
            </div>
            <div class="step">
                <div class="step-icon">❤️</div>
                <h3>Adopt</h3>
                <p>Find your new furry friend and give them a forever home.</p>
            </div>
            <div class="step">
                <div class="step-icon">✂️</div>
                <h3>Grooming & Training</h3>
                <p>Find grooming services and training resources to help your pets thrive.</p>
            </div>
            <div class="step">
                <div class="step-icon">🏥</div>
                <h3>Vet Support</h3>
                <p>Access veterinary support for your pets' health needs.</p>
            </div>
        </div>
    </section>
    ...
    <section class="testimonial">
        <div class="container">
            <div class="testimonial-item active">
                <q>Thanks to SafePaws, I found my furry best friend and the process was so smooth!</q>
                <p>- Aakriti P.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>SafePaws made the adoption process easy and stress-free. Highly recommend!</q>
                <p>- Sumiran M.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>We Took a pet through SafePaws and the experience was wonderful.</q>
                <p>- Yujal M.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>Their vet support services are top-notch. My pets love them!</q>
                <p>- Rose S.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>Thank you SafePaws for connecting us with our newest family member!</q>
                <p>- Sudip P.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
            ...
            <div class="testimonial-item">
                <q>Incredibly supportive team, very easy to work with!</q>
                <p>- Sujal M.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>SafePaws connected us with a wonderful rescue dog. We're so happy!</q>
                <p>- Prashank P.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>I never knew adoption could be so simple. Thank you SafePaws!</q>
                <p>- Lakas M.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
            <div class="testimonial-item">
                <q>Very professional and helpful. They truly care about animals!</q>
                <p>- Rojan C.</p>
                <div class="stars">⭐⭐⭐⭐⭐</div>
            </div>
        </div>
