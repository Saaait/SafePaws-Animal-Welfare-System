...
<head>
    ...
    <link rel="stylesheet" href="../CSS/ad.css"> <!-- page specific css -->
    <link rel="stylesheet" href="../CSS/adopt.css"><!--Adopt css-->
...
<body>
    ...
    <!-- Middle Section with Clickable Boxes -->
    <section class="adoption-section">
        <h1>Select a Pet Category</h1>
        <div class="box-container">
            <!-- Dog Box -->
            <div class="adoption-box">
                <a href="Adog.php">
                    <img src="../Images/dog.jpg" alt="Dog Adoption">
                    <h2>Dogs</h2>
                </a>
            </div>
            ...
            <div class="adoption-box">
                <a href="Acat.php">
                    <img src="../Images/cat.jpg" alt="Cat Adoption">
                    <h2>Cats</h2>
                </a>
            </div>
        </div>
